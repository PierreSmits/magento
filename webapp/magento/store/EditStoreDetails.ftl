...
<form method="post" id="companyInfo" class="requireValidation ajaxMe" data-successMethod="#storeInformation" data-errorMethod="#storeInformation" data-ajax-loader="#editStoreDetails-ajax-loader" action="<@ofbizUrl>createUpdateStoreInformation</@ofbizUrl>">
  ...
  <div class="form-group row">
    <div class="col-lg-12 col-md-12">
      <button type="submit" class="btn btn-primary">
        ...
        <span id="editStoreDetails-ajax-loader" class="ajax-loader" style="display:none"></span>
      </button>
    </div>
  </div>
</form>